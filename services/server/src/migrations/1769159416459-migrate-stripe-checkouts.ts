...
export class MigrateStripeCheckouts1769159416459 extends Migration {
  // eslint-disable-next-line @typescript-eslint/require-await
  public async up(): Promise<void> {
    this.addSql(`
        ALTER TABLE ${ns}.stripe_checkout ADD COLUMN offer_id uuid;
        ...
        DROP INDEX IF EXISTS ${ns}.stripe_checkout_asset_id_fkey;
  ...
  public async down(): Promise<void> {
    this.addSql(`
        ALTER TABLE ${ns}.stripe_checkout ADD COLUMN asset_id uuid;

        UPDATE ${ns}.stripe_checkout stripe
        ...
        DROP INDEX IF EXISTS ${ns}.stripe_checkout_offer_id_fkey;
