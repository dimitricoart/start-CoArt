...
export type THierarchyEventType = Erc20EventType | Erc721EventType | Erc1155EventType | Erc1363EventType;

export type THierarchyEventData = TErc20Events | TErc721Events | TErc1155Events | TErc1363Events;
